...
namespace {
	...
	final class GrammarParser extends Parser
	{
		public const T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, 
               T__6 = 7, T__7 = 8, T__8 = 9, T__9 = 10, T__10 = 11, FUNC = 12, 
               MAIN = 13, PVAR = 14, PCONST = 15, PINT = 16, PFLOAT = 17, 
               PBOOL = 18, PSTRING = 19, NUM = 20, FLOAT = 21, NIL = 22, 
               BOOLE = 23, STRING = 24, ID = 25, LINE_COMMENT = 26, BLOCK_COMMENT = 27, 
               WS = 28;
		...
		private const LITERAL_NAMES = [
		    null, "'('", "')'", "'{'", "'}'", "'='", "':='", "'+='", "'-='", "'*='", 
		    "'/='", "','", "'func'", "'main'", "'var'", "'const'", "'int32'", 
		    "'float32'", "'boole'", "'string'", null, null, "'nil'"
		];
		...
		private const SYMBOLIC_NAMES = [
		    ...
		    null, "FUNC", "MAIN", "PVAR", "PCONST", "PINT", "PFLOAT", "PBOOL", 
		    "PSTRING", "NUM", "FLOAT", "NIL", "BOOLE", "STRING", "ID", "LINE_COMMENT", 
		    "BLOCK_COMMENT", "WS"
		];

		private const SERIALIZED_ATN =
			[4, 1, 28, 103, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 
		    ...
		    14, 93, 1, 0, 0, 0, 16, 100, 1, 0, 0, 0, 18, 19, 5, 12, 0, 0, 19, 
		    20, 5, 13, 0, 0, 20, 21, 5, 1, 0, 0, 21, 22, 5, 2, 0, 0, 22, 26, 5, 
		    ...
		    48, 5, 6, 0, 0, 48, 49, 3, 10, 5, 0, 49, 51, 1, 0, 0, 0, 50, 36, 1, 
		    0, 0, 0, 50, 42, 1, 0, 0, 0, 50, 46, 1, 0, 0, 0, 51, 5, 1, 0, 0, 0, 
		    52, 53, 5, 25, 0, 0, 53, 54, 5, 5, 0, 0, 54, 68, 3, 16, 8, 0, 55, 
		    56, 5, 25, 0, 0, 56, 57, 5, 7, 0, 0, 57, 68, 3, 16, 8, 0, 58, 59, 
		    5, 25, 0, 0, 59, 60, 5, 8, 0, 0, 60, 68, 3, 16, 8, 0, 61, 62, 5, 25, 
		    0, 0, 62, 63, 5, 9, 0, 0, 63, 68, 3, 16, 8, 0, 64, 65, 5, 25, 0, 0, 
		    65, 66, 5, 10, 0, 0, 66, 68, 3, 16, 8, 0, 67, 52, 1, 0, 0, 0, 67, 
		    55, 1, 0, 0, 0, 67, 58, 1, 0, 0, 0, 67, 61, 1, 0, 0, 0, 67, 64, 1, 
		    0, 0, 0, 68, 7, 1, 0, 0, 0, 69, 74, 5, 25, 0, 0, 70, 71, 5, 11, 0, 
		    0, 71, 73, 5, 25, 0, 0, 72, 70, 1, 0, 0, 0, 73, 76, 1, 0, 0, 0, 74, 
		    72, 1, 0, 0, 0, 74, 75, 1, 0, 0, 0, 75, 9, 1, 0, 0, 0, 76, 74, 1, 
		    0, 0, 0, 77, 82, 3, 16, 8, 0, 78, 79, 5, 11, 0, 0, 79, 81, 3, 16, 
		    8, 0, 80, 78, 1, 0, 0, 0, 81, 84, 1, 0, 0, 0, 82, 80, 1, 0, 0, 0, 
		    82, 83, 1, 0, 0, 0, 83, 11, 1, 0, 0, 0, 84, 82, 1, 0, 0, 0, 85, 88, 
		    5, 14, 0, 0, 86, 88, 5, 15, 0, 0, 87, 85, 1, 0, 0, 0, 87, 86, 1, 0, 
		    0, 0, 88, 13, 1, 0, 0, 0, 89, 94, 5, 16, 0, 0, 90, 94, 5, 17, 0, 0, 
		    91, 94, 5, 18, 0, 0, 92, 94, 5, 19, 0, 0, 93, 89, 1, 0, 0, 0, 93, 
		    90, 1, 0, 0, 0, 93, 91, 1, 0, 0, 0, 93, 92, 1, 0, 0, 0, 94, 15, 1, 
		    0, 0, 0, 95, 101, 5, 20, 0, 0, 96, 101, 5, 21, 0, 0, 97, 101, 5, 23, 
		    0, 0, 98, 101, 5, 24, 0, 0, 99, 101, 5, 22, 0, 0, 100, 95, 1, 0, 0, 
		...
		public function s(): Context\SContext
		{
		    ...
		    try {
		        ...
		        $_la = $this->input->LA(1);
		        while (((($_la) & ~0x3f) === 0 && ((1 << $_la) & 33603584) !== 0)) {
		        	$this->setState(23);
		        	$this->stmts();
		        	$this->setState(28);
		        	$this->errorHandler->sync($this);
